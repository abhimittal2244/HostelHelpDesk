...
namespace HostelHelpDesk.Migrations
{
    ...
    [Migration("20250818133003_Initials1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkerWorkerType", b =>
                {
                    b.Property<int>("WorkerSpecializationId")
                        .HasColumnType("int");

                    b.Property<int>("WorkersId")
                        .HasColumnType("int");

                    b.HasKey("WorkerSpecializationId", "WorkersId");

                    b.HasIndex("WorkersId");

                    b.ToTable("WorkerWorkerType");
                });
            ...
            modelBuilder.Entity("WorkerWorkerType", b =>
                {
                    b.HasOne("HostelHelpDesk.Domain.Models.WorkerType", null)
                        .WithMany()
                        .HasForeignKey("WorkerSpecializationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
